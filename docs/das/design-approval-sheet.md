...
| # | Item | Status | Evidência |
|---|---|---|---|
| 16 | Cobertura de testes ≥ 80% | ✅ | 94,52% (`pytest --cov`) |
| 17 | Testes passando | ✅ | 210/210 passando + 3 subtests |
...
| 23 | Schema OpenAPI válido | ✅ | 34 caminhos, 60 operações e validação sem erros |
